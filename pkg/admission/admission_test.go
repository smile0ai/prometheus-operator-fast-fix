...
import (
	...
	"github.com/smile0ai/prometheus-operator-fast-fix/pkg/apis/monitoring/v1alpha1"
	"github.com/smile0ai/prometheus-operator-fast-fix/pkg/apis/monitoring/v1beta1"
)
