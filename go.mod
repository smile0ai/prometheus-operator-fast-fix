module github.com/smile0ai/prometheus-operator-fast-fix
...
require (
	...
	github.com/smile0ai/prometheus-operator-fast-fix/pkg/client
...
replace (
	github.com/smile0ai/prometheus-operator-fast-fix/pkg/apis/monitoring => ./pkg/apis/monitoring
	github.com/smile0ai/prometheus-operator-fast-fix/pkg/client => ./pkg/client
